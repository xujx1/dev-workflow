...
| 资源 | 路径 |
|------|------|
| 执行规则详情 | `agents/archive-report/assets/execution-rules.md` |
| 报告模板 | `agents/archive-report/assets/archive-report-template.md` |

## 执行流程

> ⚠️ **必须先 Read `agents/archive-report/assets/execution-rules.md`，获取完整执行细则后再操作。**

```
Step 4-3-A: Read agents/archive-report/assets/execution-rules.md → 确定飞书上传目标（迭代号三级查找）
